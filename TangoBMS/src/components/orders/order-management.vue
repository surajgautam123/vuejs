            ...
            <div class="col-md-12">
                <div class="panel-body">
                    <div class="m-b10 text-right">
                        <div class="chart-toggle-button">
		                    <a class="btn btn-primary" title="Add New Order" ui-sref="orders.create" href="#/orders/create-order/"><i aria-hidden="true" class="fa fa-plus"></i> Add New Order</a>
		                    <a class="btn btn-primary hide" title="Create Supplier Label Order" ui-sref="orders.label-supplier-order" href="#/orders/label-supplier-order"><i aria-hidden="true" class="fa fa-list"></i> Create Supplier Label Order</a>
		                    <a class="btn btn-primary" title="Advanced Search" ng-click="olCtrl.advancedSearch();"><i aria-hidden="true" class="fa fa-search"></i> Advanced Search</a>
		                </div>
                    </div>
                    <vue-good-table
                        title="Dynamic Table"
